...
public class NotProd {
    ...
    CommandLineRunner initData(
        ...
        return args -> {
            ...
            Member memberUser6ByGoogle = memberService.whenSocialLogin("GOOGLE", "GOOGLE__109725510932460602319").getData();
            ...
            for(int i=11; i<=20; i++) {
                likeablePersonService.like(memberUser4, "insta_user%d".formatted(i), 2);
            }
        };
    }
}
